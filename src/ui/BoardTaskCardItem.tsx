...
function BoardTaskCardItem({ task }: { task: tasktype }) {
  ...
  return (
    <>
      <div
        className="relative space-y-3 bg-slate-100 px-5 py-4 rounded-lg border border-slate-300 cursor-pointer transition dark:bg-slate-700 dark:border-slate-800"
        ref={ref}
      >
