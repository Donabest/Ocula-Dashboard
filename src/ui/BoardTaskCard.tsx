    ...
    <>
      <div className=" space-y-4 bg-white/90 p-3 h-fit rounded-lg dark:bg-slate-800">
        {Tasks.map((task, index) => (
          <div
            className="relative space-y-3 bg-gray-100 px-5 py-4 rounded-lg border border-slate-300 cursor-pointer hover:scale-101 transition dark:bg-slate-700 dark:border-slate-800"
            key={index}
          >
