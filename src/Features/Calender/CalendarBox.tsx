  ...
  return (
    <section className="flex-1">
      <div className="flex items-start justify-center text-center mt-3 ">
        <div className="">
          <h1 className="w-25 p-3 font-normal text-gray-500 bg-gray-200 border border-slate-300 rounded-l-lg dark:border-slate-700 dark:bg-slate-800 dark:text-slate-400">
            Time
          </h1>
        ...
        <div className="flex-1 relative">
          <div className="grid grid-cols-5 text-gray-500  bg-gray-200 dark:bg-slate-800  dark:text-slate-400 ">
